 ...
 * 
 * SerialDebuger
 * RTClib.h     - Adafruit library for RTC, brings in a depedency on a one wire library.
 * NewTone.h    - ?
 * OneWire.h    - Maybe redundant with RTC one wire library?
 * DallasTemperature.h
 * TinyGPS++.h
 * DHT.h
 * SFE_BMP180.h
 ...
 * SPI.h  : ???
 * Adafruit_Sensor.h 
 * Adafruit_BME280.h -> Adafruit Unified Sensor
 * 
 * FAILURE ERROR CODES
